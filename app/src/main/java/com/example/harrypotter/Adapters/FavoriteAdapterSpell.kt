...
class FavoriteAdapterSpell(val context: Context, val list: List<FavoriteDataSpell>) :
    RecyclerView.Adapter<FavoriteAdapterSpell.SpellViewHolder>() {
    ...
    override fun onBindViewHolder(holder: SpellViewHolder, position: Int) {
        ...
        holder.description.text = list[position].description ?: "No Name"
